...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      console.log("Starting automatic bundle sending for reward:", reward.id)
      ...
      if (qrData.sku_id) {
        ...
        if (weight === "340g") {
          bundleSize = "50MB"
          sendTimes = 2
          console.log("340g SKU detected - sending 50MB twice (total 100MB)")
        } else if (weight === "500g") {
          bundleSize = "50MB"
          sendTimes = 3
          console.log("500g SKU detected - sending 50MB three times (total 150MB)")
        } else {
      ...
      console.log("Sending data bundle:", { bundleSize, sendTimes, phoneNumber: customerPhone })
      ...
      console.log("Data bundle sent successfully:", result.data?.transactionId)
